...
export default function WeeklyKPIs() {
  const { kpiData, resetWeeklyValues, isLoading } = useKpi();
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <h1 className="text-3xl font-bold tracking-tight">Weekly KPIs</h1>
        </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Weekly KPIs Breakdown</CardTitle>
          <CardDescription>
