...
import { BarChart3, CalendarDays, Gauge, LineChart, Settings, User } from "lucide-react";
...
export function Sidebar({ className }: SidebarProps) {
  ...
  return (
    <div className={cn("flex h-screen flex-col border-r bg-sidebar", className)}>
      ...
      <div className="mt-auto p-4">
        <div className="flex items-center gap-2 rounded-lg bg-sidebar-accent p-4">
          ...
          <div>
            ...
            <p className="text-xs text-white/70">Senior SDR</p>
          </div>
        </div>
      </div>
    </div>
